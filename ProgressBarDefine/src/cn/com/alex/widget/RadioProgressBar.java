...
public class RadioProgressBar extends ProgressBar {
	...
	public RadioProgressBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		initPaint();
	}

	public RadioProgressBar(Context context, AttributeSet attrs, int defStyle) {

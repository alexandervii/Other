    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.obtain_token_via_sso).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                mSsoHandler = new SsoHandler(UserAuthActivity.this, mWeiboAuth);
    ...
    class AuthListener implements WeiboAuthListener {
        ...
        public void onComplete(Bundle values) {
            ...
            if (mAccessToken.isSessionValid()) {
                ...
                AccessTokenKeeper.writeAccessToken(UserAuthActivity.this, mAccessToken);
                ...
                Toast.makeText(UserAuthActivity.this, message, Toast.LENGTH_LONG).show();
            }
        }
